...
export default function Option({ itemData, id, currentRightOption, selected, onOptionClick }) {
  let optionStyle;
  ...
  return (
    <li className={optionStyle}>
      <button type="button" onClick={() => onOptionClick(id)} className={styles.options_button}>
        {itemData}
      </button>
    </li>
  );
